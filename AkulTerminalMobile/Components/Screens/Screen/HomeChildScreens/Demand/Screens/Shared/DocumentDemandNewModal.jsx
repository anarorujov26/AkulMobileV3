...
const DocumentDemandNewModal = ({ route, navigation }) => {

  const { customerInfo, setCustomerInfo } = useContext(DemandsGlobalContext);
  ...
  const getInfo = async () => {
    ...
    if (customerInfo != null) {
      productOBJ.Price = productOBJ.Price - (productOBJ.Price / 100) * ConvertFixedTable(customerInfo.Discount);
    }
...
export default DocumentDemandNewModal
