...
const EmployeesModal = ({ modalVisible, setModalVisible, idType, nameType, state, save }) => {

    const [group, setGroup] = useState([]);

    const getGroups = async () => {
        const result = await Api('employees/get.php', { token: await AsyncStorage.getItem('token') })
