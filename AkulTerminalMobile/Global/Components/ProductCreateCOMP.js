...
import PriceTypeProsessing from '../../Components/Screens/Screen/HomeChildScreens/Products/PriceTypeProsessing'
import CustomSuccessSaveButton from '../UI/CustomSuccessSaveButton'
import AntDesign from 'react-native-vector-icons/AntDesign';
import PricePermission from './PricePermission'
import modificationsGroup from './modificationsGroup'
import DocumentInItems from './DocumentInItems'
import axios from 'axios'
import RNPrint from 'react-native-print'
import TmpModal from './Modals/TmpModal'
import getTemplates from './getTemplates'

const ProductCreateCOMP = ({ route, navigation }) => {
